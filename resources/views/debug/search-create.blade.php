...
<!-- page style -->
<link rel="stylesheet" href="/css/map-shell.css">
...
<!-- micro event lib -->
<script type="text/javascript" src="/js/include/micro-event.js?101"></script>
<!-- map functions -->
<script type="text/javascript" src="/js/include/map/google-maps-functions.js?101"></script>
<script type="text/javascript" src="/js/include/map/map-class.js?101"></script>
...
$(function() {
    ...
    googleMapsLoaded(function(google)
    {
        ...
        var defaultMapOptions = {
            center: new google.maps.LatLng(53.53824731, 33.69611538), // Zhukovka
            zoom: 14,
            mapTypeControl: false,
            streetViewControl: false,
            disableDefaultUI: true,
            mapTypeId: 'OSM', // defined internally in the MapShell
        };
    
        // create map shell
        var shellmap = new MapShell(defaultMapOptions, 'map-modal-template');
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8 col-xs-12" id="search-you-container">
          <div class="widget-header">
              {{-- <h3 class="widget-caption">Поиск человека:</h3> --}}
          </div>
...
{{-- Templates --}}
@push('templates')
{{-- Google map templates --}}
<!-- Modal -->
<div id="map-modal-template" class="modal" role="dialog">
...
$(function() {
    ...
    // dmanager.data.bind('removefeature', function(feature, type) {
    //   // addfeature
    //   // removefeature
    // });

    // dmanager.data.bind('feature:selectfocus', function(feature) {
    //     // feature:selectfocus
    //     // feature:selectblur
    //     // feature:selectchange
    //     // log('focus');
    // });


    // // dmanager.data.addFeature( circleFeature );
    // // dmanager.data.removeFeature( circleFeature );
