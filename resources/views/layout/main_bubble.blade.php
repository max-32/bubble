...
<head>
  ...
  <title>@yield('title', 'Bubble')</title>
  ...
  <nav class="navbar navbar-white navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        {{-- <a class="navbar-brand" href="/"><b>Bubble</b></a> --}}
  ...
  <footer class="footer">
    <div class="container">
      <p class="text-muted" style="font-size: .8em;">
        <span class="small">
          Copyright © <a href="{{ url('/') }}">bubble.com</a>
        </span>
      </p>
    </div>
    ...
    <script type="text/javascript">
      ...
      try {
        @if (Auth::check())
          var userAuth = {!! Auth::user()->info->toJson() !!};
        @else
          var userAuth = null;
        @endif
        ...
        @if (isset($userCurrent))
          var userCurrent = {!! $userCurrent->info->toJson() !!};
        @else
