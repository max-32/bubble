...
function ControlsManagerShell(dmanagerShell) {
	...
	function __createControlsPanel() {
		var controlUI = document.createElement('div');
			controlUI.className = 'map-control-pn-horisontal';
	...
	function __createControlsPanelVertical() {
		var controlUI = document.createElement('div');
			controlUI.className = 'map-control-pn-vertical';
	...
	function __createControlElement(innerHTML, id, t) {
		var item = document.createElement('div');
			 item.className = 'map-control-element';
	...
	function init(dmanagerShell) {
		dmanagerShell.map().controls[google.maps.ControlPosition.TOP_LEFT].push( this.controlsPanelVertical );
